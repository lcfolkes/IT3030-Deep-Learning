...
if __name__ == "__main__":
	...
	# autoencoder_standard = Autoencoder(gen_standard, epochs=15, learning_rate=lr, batch_size=512, force_learn=True)
	#
	...
	# autoencoder_missing = Autoencoder(gen_missing, epochs=15, learning_rate=lr, batch_size=512, force_learn=True)
	...
	# autoencoder_stacked = Autoencoder(gen_standard, epochs=15, learning_rate=lr, batch_size=512, force_learn=True)
	#
	...
	# autoencoder_stacked_missing = Autoencoder(gen_missing, epochs=15, learning_rate=lr, batch_size=512, force_learn=True)
