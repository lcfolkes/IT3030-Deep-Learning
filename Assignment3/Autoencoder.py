...
class Autoencoder:
	def __init__(self, encoder, learning_rate=0.005, loss_function='binary_crossentropy', optimizer='adam',
				 epochs=15):
		# data
		self.x_train = encoder.x_train
		self.y_train = encoder.y_train
